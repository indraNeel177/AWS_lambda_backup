...
def lambda_handler(event, context=None):
    ...
    if year and not month and not day:
        where_caluse = """ where "op"."year" ='{}' """.format(year)
    elif year and month and not day:
        where_caluse = """ where "op"."year" ='{}' and  "op"."month" ='{}'""".format(str(year), str(month))
    elif year and month and day:
        where_caluse = """ where "op"."year" ='{}' and "op"."month" ='{}' and "op"."day" ='{}'""".format(year, month,
                                                                                                         day)
    query_for_flight_handled= """ SELECT airportname,location,operatorname,operatorid,certificationlevel,attended,validtill,
                                    is_active,year,month,day FROM operatorprofile  as op {} and entity='9' and airport='13' """.format(where_caluse)
